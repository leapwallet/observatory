...
async function lastHourDowntimeP0ChainsCheck() {
  console.log('Running NMS Last One Hour Downtime P0 Chains Check...');
  ...
  if (rawData.some((d) => d.is_downtime_hour === 'Yes')) {
    // Generate a comma-separated list of affected chains
      ...
      blocks: [
        {
          ...
          text: {
            type: 'mrkdwn',
            text: '*NMS P0 Chains Last One Hour Downtime Alert*',
          },
        },
        {
          type: 'section',
        ...
        },
        {
          ...
          text: {
            type: 'mrkdwn',
            text: `For more details, see the <https://metabase.leapwallet.io/question/288-d-NMS-last-one-hour-downtime-p0-chains-check|report>.`,
          },
        },
      ],
      attachments: [
    ...
    console.log('No NMS downtime detected in the last hour.');
  }
}

async function lastHourDowntimeP1ChainsCheck() {
  console.log('Running NMS Last One Hour Downtime P1 Chains Check...');
      ...
      blocks: [
        {
          ...
          text: {
            type: 'mrkdwn',
            text: '*NMS P1 Chains Last One Hour Downtime Alert*',
          },
        },
        {
          type: 'section',
        ...
        },
        {
          ...
          text: {
            type: 'mrkdwn',
            text: `For more details, see the <https://metabase.leapwallet.io/question/291-d-NMS-last-one-hour-downtime-p1-chains-check|report>.`,
          },
        },
      ],
      attachments: [
...
cron.schedule('0 * * * *', () => {
  console.log('Running scheduled task for NMS Last One Hour Downtime P0 Chains Check...');
