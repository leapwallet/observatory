...
async function lastHourDowntimeCheck() {
  console.log('Running All Nodes Last One Hour Downtime Check...');
      ...
      blocks: [
        {
          ...
          text: {
            type: 'mrkdwn',
            text: '*AllNodes Last One Hour Downtime Alert*',
          },
        },
        {
          type: 'section',
        ...
        },
        {
          ...
          text: {
            type: 'mrkdwn',
            text: `For more details, see the <https://metabase.leapwallet.io/question/289-d-allnodes-last-one-hour-downtime-check|report>.`,
          },
        },
      ],
      attachments: [
...
cron.schedule('0 * * * *', () => {
  console.log('Running scheduled task for All nodes Last One Hour Downtime Check...');
