...
async function lastHourDowntimeP0ChainsCheck() {
  console.log('Running Numia Last One Hour Downtime P0 Chains Check...');
      ...
      blocks: [
        {
          ...
          text: {
            type: 'mrkdwn',
            text: '*Numia P0 Chains Last One Hour Downtime Alert*',
          },
        },
        {
          type: 'section',
        ...
        },
        {
          ...
          text: {
            type: 'mrkdwn',
            text: `For more details, see the <https://metabase.leapwallet.io/question/288-d-numia-last-one-hour-downtime-p0-chains-check|report>.`,
          },
        },
      ],
      attachments: [
...
async function lastHourDowntimeP1ChainsCheck() {
  console.log('Running Numia Last One Hour Downtime P1 Chains Check...');
      ...
      blocks: [
        {
          ...
          text: {
            type: 'mrkdwn',
            text: '*Numia P1 Chains Last One Hour Downtime Alert*',
          },
        },
        {
          type: 'section',
        ...
        },
        {
          ...
          text: {
            type: 'mrkdwn',
            text: `For more details, see the <https://metabase.leapwallet.io/question/291-d-numia-last-one-hour-downtime-p1-chains-check|report>.`,
          },
        },
      ],
      attachments: [
...
cron.schedule('0 * * * *', () => {
  console.log('Running scheduled task for Numia Last One Hour Downtime P0 Chains Check...');
